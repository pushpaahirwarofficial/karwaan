...
<head>
  ...
  <title>Admin Newsletter| Karwaan</title>
  ...
  <section id="container" class="">
    <!--header start-->
     ...
     <section class="wrapper">
        <div class="row">
           <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i>Newsletter</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../../admin_index">Home</a></li>
              <li><i class="fa fa-th-list"></i><a href="../getData_newsletter">Newsletter</a></li>
              <li><i class="fa fa-th-list"></i>Newsletter View</li>
	   ...
	   <header class="panel-heading" style="margin-left:14.5%; margin-right:20px">All Newsletter
        ...
        <div id="a"  style="background-color:white">
               <div class="box-header">
					 ...
					 <a  href="../getData_newsletter" class="btn btn-primary"> << </a>
            ...
            <div class="box-body" style="overflow:none; background-color:white">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <th width="30%">Email</th><td width="70%"><?php echo $row->email; ?> </td>
				</tr>
                  <tr>				  
                  <th width="30%">Read</th><td width="70%"> <?php if($row->isRead==0){echo "No";}
                                                                  else{echo "Yes";} ?></td>  			  
                </tr>
				
				<tr>				  
                  <th width="30%">Create Date</th><td width="70%"><?php echo $row->createdate; ?></td>  			  
                </tr>
