...
<head>
  ...
  <link rel="shortcut icon" href="img/assest_adminvicon.png">
  ...
  <section id="container" class="">
    <!--header start-->
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i>Testimonial</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../../admin_index">Home</a></li>
              <li><i class="fa fa-th-list"></i><a href="./getData_testimonial">Testimonial</a></li>
              <li><i class="fa fa-th-list"></i>Testimonial add</li>
     ...
     <section id="a" style="background-color:white">
	 <div>
    <form role="form" action="./insert_testi" enctype="multipart/form-data" method="post">
              ...
              <?php if($validation->getError('te_name')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="te_name" class="form-control" placeholder="Enter Name">							
						</div>
					</div>	
						<div class="form-group col-md-6">
						<div class="form-group">
							<label>Testimonial Rating</label>
							<select class="form-control select2 " name="te_rating">
              ...
              <?php if($validation->getError('te_img')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="file" name="te_img" class="form-control" placeholder=" Select Image">							
						</div>
					</div>
              ...
              <?php if($validation->getError('te_title')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="te_title" class="form-control" placeholder="Enter title">							
						</div>
					</div>
              ...
              <?php if($validation->getError('te_designation')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="te_designation" class="form-control" placeholder="Enter Designation">							
						</div>
					</div>
					...
					<div class="form-group col-md-6">
						<div class="form-group">
							...
							<select class="form-control select2 " name="te_priority">
							<option value="1">1</option>						
							<option value="2">2</option>						
							<option value="3">3</option>						
              ...
              <?php if($validation->getError('te_discrip')) { ?>
                  ...
                  <?php } ?>
							...
							<textarea name="te_discrip"  class="form-control ckeditor" placeholder="Enter description"></textarea>							
						</div>
					</div>	
          ...
          <button type="submit" name="submit" class="btn btn-primary">Add</button>
			    ...
			    <a href="./getData_testimonial" class="btn btn-danger"><i class="assest-arrow-circle-left"></i>Back</a>
          </div>	
