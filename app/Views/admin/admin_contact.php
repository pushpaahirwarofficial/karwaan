  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-youtube-o"></i> Contact</h3>
            <ol class="breadcrumb">
...
<div id="a"  style="background-color:white">
		    <div class="col-lg-12">
			   ...
			   <div class="box-body">
				  ...
				  <thead>
					...
					<!--here we are  fetching the data from the data froom the table-->
					<tbody>
			...
			<tr id="<?php echo $row->contact_id;?>">
                  ...
                  <td> <?php echo $row->c_msg; ?> </td>
				   <td> <?php echo $row->c_time; ?> </td>
		
          <td>
					<div class="btn-group">
					<input type="hidden" name="contact_id" value="<?php echo $row->contact_id;?>">
						<a class="btn btn-primary" href="./view_contact/<?php echo $row->contact_id;?>"><i class="icon_plus_alt2"></i></a>
						<!-- <a class="btn btn-danger" href="./remove_contact/<?php //echo $row->contact_id;?>"><i class="icon_close_alt2"></i></a> -->
