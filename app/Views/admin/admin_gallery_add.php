        ...
        <form action="./insert_gallery" method="post" enctype="multipart/form-data">
              ...
              <?php if($validation->getError('gl_name')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="gl_name" class="form-control" placeholder="Enter Name">							
						</div>
					</div>	
						...
						<div class="form-group">
							...
							<select class="form-control select2 " name="gl_type">
              ...
              <?php if($validation->getError('gl_img')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="file" name="gl_img" class="form-control" placeholder="Upload image" accept="image/*">							
						</div>
					</div>
              ...
              <?php if($validation->getError('gl_alt')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="gl_alt" class="form-control" placeholder="Enter Alter">							
						</div>
					</div>
					...
					<div class="form-group col-md-6">
						<div class="form-group">
							...
							<select class="form-control select2 " name="gl_priority">
			  ...
			  <!-- /.box-body -->
			    <div class="box-footer">
			        ...
			        <a href="./getData_gallery" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i>Back</a>
                </div>			   
			</form>
			</div>
