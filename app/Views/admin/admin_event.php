 ...
 <header class="panel-heading" style="margin-left:14.5%; margin-right:20px">All Events
	   ...
	   <div id="a" style="background-color:white">
		    <div class="col-lg-12" >
					...
					<a href="./add_event"  class="btn btn-info">
					Add Event  &nbsp <i class="fa fa-plus" ></i></a>
          ...
          <table id="myTable" class="display">
			...
			<tr id="<?php echo $row->n_id;?>">
                 <td> <?php echo $count; ?> </td>
                  ...
                  <?php } else { ?>
                    <img src="<?php echo base_url('assest/user/images/event/').$row->n_img; ?>" width="200px" height="100px" >
                  <?php } ?>
                  </td>
                  <td> <?php echo $row->n_priority; ?> </td>
					
                  	<td>
					<div class="btn-group">
					<input type="hidden" name="n_id" value="<?php echo $row->n_id;?>">
						<a class="btn btn-primary" href="./view_event/<?php echo $row->n_id;?>"><i class="icon_plus_alt2"></i></a>
						<a class="btn btn-success" href="./edit_event/<?php echo $row->n_id;?>"><i class="icon_check_alt2"></i></a>
						<input type="hidden" value="<?php echo $row->n_img;?>" name="n_img">
						  
						<!-- <a class="btn btn-danger" href="./delete_event/<?php //echo $row->n_id;?>"><i class="icon_close_alt2"></i></a> -->
