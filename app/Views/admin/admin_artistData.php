  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-youtube-o"></i> Artist Data</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../../admin_index">Home</a></li>
              <li><i class="icon_document_alt"></i>Artist Data</li>            
            </ol>
          </div>
        </div>
		</section>
...
<div id="a" style="background-color:white">
		    ...
		    <div class="col-lg-12">
					...
					<a href="./add_artist"  class="btn btn-info">
          ...
          <table id="myTable" class="display">
			...
			<tr id="<?php echo $row->artist_id;?>">
				  ...
				  <?php
				   if($row->type==1){
				  ?>
                    <td> <img  src='<?php echo base_url("assest/user/images/artist/").$row->image_video; ?>' width="200px" height="100px" ></td>
					<?php
				   }
				   else {
					?>
                  ...
                  <td> <?php 
					...
					<input type="hidden" name="id" value="<?php echo $row->artist_id;?>">
						<a class="btn btn-primary" href="./view_artistData/<?php echo $row->artist_id; ?>"><i class="icon_plus_alt2"></i></a>
						<a class="btn btn-success" href="./edit_artistData/<?php echo $row->artist_id;?>"><i class="icon_check_alt2"></i></a>
						 <input type="hidden" name="id" value="<?php echo$row->id;?>">
				            <?php if($row->type==1){?>
						<input type="hidden" name="image_video" value="<?php echo $row->image_video;?>">
						  <?php } ?>
						<!-- <a class="btn btn-danger" href="./delete_artistData/<?php //echo $row->artist_id; ?>"><i class="icon_close_alt2"></i></a> -->
