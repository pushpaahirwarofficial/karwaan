        ...
        <div class="row">
           <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i>Achievement Update</li>
      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
			<!-- Work Area Start-->
			   <form role="form" action="../update_achievement/<?php echo $row->achieve_id; ?>" enctype="multipart/form-data" method="post">
			   <div class="box-body">
				
				<div class="form-group col-md-6">
                  <label>Achievement ID</label>
				  <input type="text" class="form-control" name="achieve_id" value="<?php echo $row->achieve_id; ?>"  readonly>
				...
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="achieve_name" value="<?php echo $row->achieve_name; ?>" >
                  
                </div>
				
				<div class="form-group col-md-6">
                  <label>Achievement Type</label>
				  <select  class="form-control" name="achieve_type" value="<?php $type=$row->achieve_type; ?>" >
					...
					<div class="form-group ">
						<div class="form-group col-md-6">
							...
							<?php $priority=$row->achieve_priority;?>
							<select  class="form-control" name="achieve_priority" >
              ...
              <?php if($validation->getError('achieve_alt')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="achieve_alt" class="form-control" value="<?php echo $row->achieve_alt;?>">							
						</div>
					</div>	
          
          <div class="form-group col-md-6" class="box-footer">
					 <a  href="../getData_achievement" class="btn btn-danger"> << Back</a>
					 <input type="hidden" value="<?php echo $row->achieve_id;?>">
         ...
         <div class="form-group  ">
                  ...
                  <?php } else { ?>
                    <img src="<?php echo base_url('assest/user/images/achievement/').$row->achieve_img; ?>" width="150px" height="200px" >							
                  <?php } ?>
						</div>
					</div>
					

          <form role="form" action="../update_achievement_image/<?php echo $row->achieve_id; ?>" enctype="multipart/form-data" method="post">
         	<div class="form-group ">
						<div class="form-group col-md-4">
            <?php if($validation->getError('achieve_img')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="hidden"  name="oldimage" value=<?php echo $row->achieve_img; ?>>						
							<input type="file" name="achieve_img" class="form-control" required>						
						</div>
						<div class="form-group col-md-4">						
							 <label></label><br>
               <a  href="../getData_achievement" class="btn btn-danger"> << Back</a>
