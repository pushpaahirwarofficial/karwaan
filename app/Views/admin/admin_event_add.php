...
<body>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-news"></i> Events</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../../admin_index">Home</a></li>
              <li><i class="icon_document_alt"></i><a href="./getData_event">Events</a></li>
			...
			<form action="./insert_event" enctype="multipart/form-data" method="post">
              ...
              <?php if($validation->getError('n_title')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="text" name="n_title" class="form-control" placeholder="Enter Title of ther news">							
						</div>
					</div>
              ...
              <?php if($validation->getError('n_date')) { ?>
                  ...
                  <?php } ?>
							...
							<input type="date" name="n_date" class="form-control" placeholder="Enter date">							
						</div>
					</div>
					<div class="form-group col-md-6">
						<div class="form-group">
							<label>Twitter</label>
							<input type="text" name="n_twitter" class="form-control" placeholder=" ENTER Twitter LINK">							
						</div>
					</div>
					<div class="form-group col-md-6">
						<div class="form-group">
							<label>Facebook</label>
							<input type="text" name="n_fb" class="form-control" placeholder=" Enter Facebook link">							
						</div>
					</div>
              ...
              <?php if($validation->getError('n_img')) { ?>
                  <label style="color:red;">
                  <?= $error = $validation->getError('n_img'); ?>
                  </label>
                  <?php } ?>
							
							<input type="file" name="n_img" class="form-control" placeholder=" Select Image">							
						</div>
					</div>
					...
					<div class="form-group col-md-6">
						<div class="form-group">
							...
							<select class="form-control select2 " name="n_priority">
          ...
          <div class="form-group col-md-6">
              ...
              <?php if($validation->getError('n_desc')) { ?>
                  ...
                  <?php } ?>
							...
							<textarea name="n_desc"  class="form-control ckeditor" placeholder="Enter the description"></textarea>							
						</div>
					</div>
			  ...
			  <!-- /.box-body -->
			    <div class="box-footer">
			        ...
			        <a href="./getData_event" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i>Back</a>
                 </div>			   
			</form>
		</div>
            <!-- /.box-body -->
