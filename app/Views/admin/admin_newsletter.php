  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-youtube-o"></i> Newsletter</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../../admin_index">Home</a></li>
              <li><i class="icon_document_alt"></i> Newsletter</li>
	   ...
	   <header class="panel-heading" style="margin-left:14.5%; margin-right:20px">All Newsletter
        ...
        <div class="table-responsive">
            ...
            <td> <?php echo $row->email; ?> </td>
				    <td> <?php if($row->isRead==0){echo "No";}
                             else{echo "Yes";}?> </td>
          ...
          <!-- <button type="submit" class="btn btn-success read">&#xe086;</button>					 			 -->
						<a class="btn btn-primary" href="./view_newsletter/<?php echo $row->id; ?>"><i class="icon_plus_alt2"></i></a>					
