        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i>Gallery</li>
 ...
 <header class="panel-heading" style="margin-left:14.5%; margin-right:20px">All Images
     ...
     <div id="a" style="background-color:white">
                <div class="box-header">
					...
					<a href="./add_gallery"  class="btn btn-info">
			...
			<tr id="<?php echo $row->gl_id; ?>">
                  ...
                  <td> 
                    ...
                    <?php } else { ?>
                      <img src='<?php echo base_url('assest/user/images/gallery/') .$row->gl_img; ?>' width="200px" height="100px" >
                    <?php } ?>
                </td>
				  <td> <?php  echo $row->gl_priority; ?> </td>
				   <td> <?php  echo $row->gl_alt; ?> </td>
				  <td>
					<div class="btn-group">
					<input type="hidden" name="gl_id" value="<?php echo $row->gl_id;?>">
						<a class="btn btn-primary" href="./view_gallery/<?php echo $row->gl_id;?>"><i class="icon_plus_alt2"></i></a>
						<a class="btn btn-success" href="./edit_gallery/<?php echo $row->gl_id;?>"><i class="icon_check_alt2"></i></a>
						<input type="hidden" value="<?php echo $row->gl_img;?>" name="gl_img">  
