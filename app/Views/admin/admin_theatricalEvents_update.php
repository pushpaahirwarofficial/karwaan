      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
          ...
          <?php foreach($rows->getResult() as $row){ ?>
			<form action="../update_event/<?php echo $row->tevent_id; ?>" enctype="multipart/form-data" method="post">
			...
			<?php //if(isset($error)){ echo $error;} ?>
                  ...
                  <?php } ?>
    							...
    							<input type="date" name="playdate" class="form-control" value="<?php echo $row->playdate; ?>" pattern="dd-mm-yyyy" >
							</div>
						</div>
                  ...
                  <?php } ?>
    							...
    							<input type="text" name="music" class="form-control" value="<?php echo $row->music; ?>">	
							</div>
						</div>
                  ...
                  <?php } ?>
    							...
    							<textarea name="actors"  class="form-control ckeditor" value="<?php echo $row->actors; ?>" ><?php echo $row->actors; ?></textarea>
							</div>
						</div>
                        <?php //echo $row->actors; ?>
        			    <div class="col-md-2" style="margin-top:25px;">
        			            
                                <button type="submit" class="btn btn-primary btn-block" name="submit">Update Data</button>
