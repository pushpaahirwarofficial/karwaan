...
<head>
  ...
  <title>Admin Contact| Karwaan</title>
  ...
  <section id="container" class="">
    <!--header start-->
     ...
     <section class="wrapper">
        <div class="row" >
           <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i><a href="../getData_contact">Contact</a></li>
              <li><i class="fa fa-th-list"></i>Contact View</li>
	   ...
	   <header class="panel-heading" style="margin-left:14.5%; margin-right:20px">All Contacts
	   </header>
        <div id="a"  style="background-color:white">
               <div class="box-header">
              		  
					 <a  href="../getData_contact" class="btn btn-primary"> << </a>
            ...
            <div class="box-body" style="overflow:none; background-color:white">
              ...
              <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                  <th width="30%">ID</th>	<td width="70%"> <?= $row->contact_id; ?> </td>
				</tr>				  
                <tr>
                  <th width="30%">Name</th>	<td width="70%"> <?= $row->c_name; ?> </td>
				</tr>
                <tr>
                  <th width="30%">Email</th>	<td width="70%"> <?= $row->c_email; ?> </td>
				</tr>				
                <tr>
				  <th width="30%">Phone</th> <td width="70%"> <?= $row->c_phone; ?></td>  
				</tr>				  
                 <tr>
                  <th width="30%">Subject</th>	<td width="70%"><?= $row->c_subject; ?></td>
				</tr>
                  <th width="30%">Message</th>	<td width="70%"><?= $row->c_msg; ?></td>
				</tr>				  
				
				<tr>				  
                  <th width="30%">Time</th><td width="70%"><?= $row->c_time; ?></td>  			  
                </tr>
