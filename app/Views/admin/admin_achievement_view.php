...
<head>
  ...
  <title>Admin Achievements View| Karwaan</title>
    ...
    <header class="panel-heading" style="margin-left:14.5%; margin-right:20px">All Achievement
	    ...
	    <div id="a" style="background-color:white">
               <div class="box-header">
					 ...
					 <a  href="../getData_achievement" class="btn btn-primary"> << </a>
            ...
            <div class="box-body" style="overflow:none;background-color:white ;padding-bottom:30px">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <th width="30%">Achievement ID</th>	<td width="70%"> <?php echo $row->achieve_id; ?> </td>
				</tr>	
                 <tr>
                  <th width="30%">Achievement name</th>	<td width="70%"> <?php echo $row->achieve_name; ?> </td>
				</tr>				
                <tr>
                  <th width="30%">Achievement Type</th>	<td width="70%"> <?php echo $row->achieve_type; ?> </td>
				</tr>				  
               <tr>
            ...
            <td width="70%">
                  ...
                  <?php } else { ?>
                    <img src="<?php echo base_url('assest/user/images/achievement/').$row->achieve_img; ?>" style="width:400px; height:200px"> 
                  <?php } ?>
            </td> 
				</tr>				  			  
                 <tr>
                  <th width="30%">Priority</th>	<td width="70%"> <?php echo $row->achieve_priority; ?> </td>
				</tr>				  
				
				<tr>				  
                  <th width="30%">Alt Text</th><td width="70%"> <?php echo $row->achieve_alt; ?> </td>  			  
                </tr>
               <?php
						}
			   ?>
