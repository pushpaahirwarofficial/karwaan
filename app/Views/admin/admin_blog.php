...
<?php include('commonpages/header.php'); ?>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-news"></i> Blog</h3>
            <ol class="breadcrumb">
 ...
 <header class="" style="margin-left:14.5%; margin-right:20px">
  <div class="row">
  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
            <i class="fa fa-thumbs-up"></i> 
              <div class="count"><h4 style="font-weight:bold;">
                  <?php
                      $cLike = 0;
                      foreach($countLike->getResult() as $cL) {
                        if($cL->likes == 1) {
                          $cLike++;
                        } 
                      }
              ...
              <div class="title"><h4 style="font-weight:bold;">Total Likes</h4></div>
            </div>
            <!--/.info-box-->
          </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box red-bg">
              ...
              <div class="title"><h4 style="font-weight:bold;">Total Dislikes</h4></div>
            </div>
            <!--/.info-box-->
          </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box blue-bg">
              ...
              <div class="count"><h4 style="font-weight:bold;"><?php echo $total = $countComment+$countReply; ?></div>
              <div class="title"><h4 style="font-weight:bold;">Total Comments</h4></div>
            </div>
            <!--/.info-box-->
        </div>
  </div>
	   ...
	   <div id="a" style="background-color:white">
		    <div class="col-lg-12" >
					...
					<a href="./add_blog"  class="btn btn-info">
					Add Blog  &nbsp <i class="fa fa-plus" ></i></a>
          ...
          <tbody>
			...
			<tr id="<?php echo $row->blog_id;?>">
                 <td> <?php echo $count; ?> </td>
                  ...
                  <?php } else { ?>
                      <img src="<?php echo base_url('assest/user/images/blog/').$row->blog_img; ?>" width="200px" height="100px" >
                  <?php } ?>
                  </td>
                  <td> <?php echo $row->blog_priority; ?> </td>
					
                  	<td>
					<div class="btn-group">
					<input type="hidden" name="blog_id" value="<?php echo $row->blog_id;?>">
						<a class="btn btn-primary" href="./view_blog/<?php echo $row->blog_id;?>"><i class="icon_plus_alt2"></i></a>
						<a class="btn btn-success" href="./edit_blog/<?php echo $row->blog_id;?>"><i class="icon_check_alt2"></i></a>
						<input type="hidden" value="<?php echo $row->blog_img;?>" name="blog_img">
