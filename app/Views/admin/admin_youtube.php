        ...
        <div class="row">
          <div class="col-lg-12" >
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Youtube</li>
...
<a href="./add_youtube"  class="btn btn-info">
			...
			<tr id="<?php echo $row->id;?>">
				  ...
				  { echo "Active";}
					...
					<input type="hidden" name="id" value="<?php echo $row->id;?>">
						<a class="btn btn-primary" href="./view_youtube/<?php echo $row->id; ?>"><i class="icon_plus_alt2"></i></a>
						<a class="btn btn-success" href="./edit_youtube/<?php echo $row->id; ?>"><i class="icon_check_alt2"></i></a>
