...
<head>
  ...
  <title>Admin Gallery View| Karwaan</title>
    ...
    <!--header start-->
        ...
        <div class="row">
           <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-th-list"></i>Gallery View</li>
     ...
     <div id="a">
               <div class="box-header">
					 ...
					 <a  href="../getData_gallery" class="btn btn-primary"> << </a>
            ...
            <div class="box-body" style="overflow:none;background-color:white ;padding-bottom:30px"">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <th width="30%">Gallery ID</th>	<td width="70%"> <?php echo $row->gl_id; ?> </td>
				</tr>	
                 <tr>
                  <th width="30%">Gallery name</th>	<td width="70%"> <?php echo $row->gl_name; ?> </td>
				</tr>	
                  					
                <tr>
                  <th width="30%">Gallery Type</th>	<td width="70%"> <?php echo $row->gl_type; ?> </td>
				</tr>				  
               <tr>
				  <th width="30%">Image</th>
          <td width="70%">
            <?php if(empty($row->gl_img)) { ?>
              <img src='<?php echo base_url('assest/user/images/defaultImage.jpg'); ?>' style="width:450px; height:300px" >
            <?php } else { ?>
              <img src="<?php echo base_url('assest/user/images/gallery/').$row->gl_img; ?>" style="width:450px; height:300px">
            <?php } ?>
          </td> 
				</tr>				  			  
                 <tr>
                  <th width="30%">Priority</th>	<td width="70%"> <?php echo $row->gl_priority; ?> </td>
				</tr>				  
				
				<tr>				  
                  <th width="30%">Alt Text</th><td width="70%"> <?php echo $row->gl_alt; ?> </td>  			  
                </tr>
               <?php
						}
			   ?>
